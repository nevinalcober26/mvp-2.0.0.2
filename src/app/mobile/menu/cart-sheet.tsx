...
export function CartSheet({ isOpen, onOpenChange, cartItems, onIncrement, onDecrement, onRemove }: CartSheetProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="w-full max-w-md mx-auto p-0 rounded-t-3xl border-0 bg-[#F7F9FB] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
            ...
            {/* Footer */}
            <div className="p-4 bg-[#F7F9FB] border-t border-gray-200/80 shadow-[0_-4px_12px_rgba(0,0,0,0.03)] space-y-4 shrink-0">
