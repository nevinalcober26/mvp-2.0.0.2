...
export function AppSidebar() {
  ...
  return (
    <Sidebar variant="sidebar" collapsible="icon" className="border-r">
      <SidebarHeader className="relative p-4 flex items-center justify-center">
        <EMenuIcon />
