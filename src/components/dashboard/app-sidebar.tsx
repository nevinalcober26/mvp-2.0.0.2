...
export const EMenuIcon = () => (
  <svg version="1.0" viewBox="0 0 1896 592" width="122" height="38">
...
export function AppSidebar() {
  ...
  return (
    <Sidebar variant="sidebar" collapsible="icon" className="border-r">
      <SidebarHeader className="relative p-4 flex-row items-center justify-center">
        <EMenuIcon />
        <SidebarTrigger className="absolute right-4 top-1/2 -translate-y-1/2 group-data-[state=collapsed]:hidden" />
      </SidebarHeader>
